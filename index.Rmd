...
## Do we have too many restrictions about data?
...
## Seamlessly works with tidyverse
...
```{r slide-hide, fig.height = 3}
```

---

## Slide over calendar periods (row-oriented workflow)
